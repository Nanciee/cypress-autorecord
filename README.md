...
## v3.0.0 is now live!
Version 3 is now compatible with Cypress 6-9 and includes a few fixes. If you are using an earlier cypress version, you will need to use cypress-autorecord v2.x.
